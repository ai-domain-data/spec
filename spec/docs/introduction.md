...
- **Self-hosted by design.** You add a DNS TXT record and a `.well-known/ai.json` file. Agents retrieve the data directly from you, not from another platform that might disappear or paywall access.
